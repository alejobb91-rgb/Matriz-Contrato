...
export default function SocialInterventoriaForm({ onCreated }) {
  ...
  const handleSubmit = async () => {
    ...
    const res = await fetch('http://localhost:4000/api/asociar/social-interventoria', {
      method: 'POST',
  ...
  return (
    <View style={{ padding: 16 }}>
      ...
      <Text>Memorando Aceptación</Text>
